...
var wow = new WOW(
  {
    boxClass:     'box-animated',      // animated element css class (default is wow)
    animateClass: 'black-box', // animation css class (default is animated)
...
var wow19 = new WOW(
  {
    boxClass:     'shadow-animated',      // animated element css class (default is wow)
    animateClass: 'shadowAnim', // animation css class (default is animated)
    offset:       110,          // distance to the element when triggering the animation (default is 0)
    mobile:       true,       // trigger animations on mobile devices (default is true)
    live:         true,       // act on asynchronously loaded content (default is true)
    callback:     function(box) {
